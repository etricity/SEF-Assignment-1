...
public class GameModesPanel extends JPanel implements ActionListener{
	...
	private JLabel message = new JLabel("TBDISPLAYED");
	...
	public GameModesPanel(Game game)
	{
		...
		enemyType1Button.addActionListener(this);
		enemyType2Button.addActionListener(this);
		enemyType3Button.addActionListener(this);
