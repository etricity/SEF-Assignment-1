	...
	public void importData(String file) throws FileNotFoundException
	{
		...
		input.useDelimiter(":");
			while(input.hasNextLine())
			{
				...
				if(nextToken.equals("true"))
				{
					user.addAchievement(new Achievement("Super Sonic - Defeat Speedy Monster", 2));
				}
				
				nextToken = input.next();
				if(nextToken.equals("true"))
				{
					user.addAchievement(new Achievement("All Seeing Being - Defeat Invisible Monster", 3));
				}
